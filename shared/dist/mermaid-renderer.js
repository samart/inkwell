...
export class MermaidRenderer {
    constructor(container) {
        ...
        this.blocks = new Map(); // Key by code hash
        this.idCounter = 0;
    ...
    async createDiagramWrapper(code, diagramId) {
      ...
      `;
            ...
            const toggleBtn = diagramWrapper.querySelector('.mermaid-toggle-source');
            const diagramDiv = diagramWrapper.querySelector('.mermaid-diagram');
            const sourceDiv = diagramWrapper.querySelector('.mermaid-source');
